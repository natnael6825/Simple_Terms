# import openai
#
# openai.api_key = "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"
#
# completion = openai.ChatCompletion.create(model="gpt-3.5-turbo", messages=[{"role": "user", "content": "write me a flask app "}])
